...
def test(in_value: int, out: str):
    print('This is what you sent us as input {}'.format(in_value))
    print('This is what you sent us as output {}'.format(out))
    try:
        return in_value + int(out)
    except ValueError as e:
        print('The value passed as output, {} is not an integer'.format(out))
        print('Error: ', e)
        return in_value
